...
**Status:** v2.1.0 — base v2.0.0 **USER-LOCKED 2026-07-05** (post-calibration lock gate;
P3 phase gate) plus one within-range coefficient amendment (P4 engine calibration,
§14 row 2.1.0; flagged in the P4 review per the amendment protocol).
