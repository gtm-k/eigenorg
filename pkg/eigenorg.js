 ...
 * @returns {string}
 */
export function begin_run(sim, config_json, seed) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(sim, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.begin_run(ptr0, len0, ptr1, len1, seed);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
 ...
 * @returns {string}
 */
export function get_model_version() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.get_model_version();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {number}
 */
export function monte_carlo_pi(iterations, seed) {
    const ret = wasm.monte_carlo_pi(iterations, seed);
    return ret;
}
 ...
 * @returns {string}
 */
export function run_chunk(n) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.run_chunk(n);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('eigenorg_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
